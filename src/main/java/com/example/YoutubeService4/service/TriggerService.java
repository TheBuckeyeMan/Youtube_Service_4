...
public class TriggerService {
    ...
    public TriggerService(DecideVideoKey decideVideoKey, GetAudioFile getAudioFile, GetVideoFile getVideoFile,CompileVideo compileVideo, PostFileToS3 postFileToS3, S3LoggingService s3LoggingService){
